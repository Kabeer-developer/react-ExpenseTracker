...
const CATS = [
  ...
  { id: "fruits", name: "Fruits", emoji: "🍎", color: "#ef4444", bg: "rgba(239,68,68,0.15)" },
  { id: "vegetables", name: "Vegetables", emoji: "🥕", color: "#22c55e", bg: "rgba(34,197,94,0.15)" },
  { id: "pocketmoney", name: "Pocket Money", emoji: "💰", color: "#8b5cf6", bg: "rgba(139,92,246,0.15)" },
];
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 20 }}>
            ...
            >
              {transactions.length === 0 ? <Empty msg="Not enough data" /> : (
                <div style={{ height: 260 }}>
                  <Bar data={{
                    labels: comparisonChartLabels, datasets: [
